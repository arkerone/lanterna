...
- edaf148: Close the remaining "never miss profiling data" gaps and reduce in-target capture overhead:
...
- 3fc4bab: Harden the capture lifecycle and the in-target hook footprint (audit follow-up):
